// NOTE: DO NOT directly import this library into your script(s).
 ...
 * and values of all kinds, with various operations.
 ...
 */
import configurator from '../../Executioner/configurator';
 ...
 * @description Convets a string to a boolean value.
 * @param {string} inputData A string that contains a truthy or falsy value and should be converted to a boolean.
 * @param {string} inputMetaData Not used for this business rule.
 * @return {boolean} A boolean value of either True or False according to the business rule converstion.
 * @author Seth Hollingsead
 * @date 2020/10/16
 ...
 * then the integer function would never get a chance to evaluate as a number.
 */
export const stringToBoolean = function(inputData, inputMetaData) {
  ...
  switch (inputData.toLowerCase().trim()) {
    case g.ctrue: case g.cTrue: case g.cTRUE: case b.ct: case b.cT: case b.cy: case b.cY:
    case g.cyes: case g.cYes: case g.cYES: case b.con: case b.cOn: case b.cON:
      returnData = true;
      break;
    case g.cfalse: case g.cFalse: case g.cFALSE: case b.cf: case b.cF: case b.cn: case b.cN:
    case b.cno: case b.cNo: case b.cNO: case g.coff: case g.cOff: case g.cOFF:
      returnData = false;
      break;
    default:
      returnData = false;
 ...
 * @description Converts a string to the appriate data value.
 * So if it's a string value of "3.1415926565897932384626433832" then it will get converted to a float of the same value.
 * It it's a string value of "false" then it will get converted to a boolean of the same value.
 ...
 * If it's an array of strings, or a collection object, it will get returned as the same as the input, no change.
 * @param {string} inputData The string that should be converted to some value.
 * @param {string} inputMetaData Not used for this business rule.
 * @return {object|string|boolean|integer} Return a value of whatever type the string should be converted to as appropriate.
 * @author Seth Hollingsead
 * @date 2020/10/16
 */
 ...
 * @description Determines if the contents of a string are actually a
 * Boolean, Integer, Float or String or something else.
 ...
 * @param {string} inputMetaData Not used for this business rule.
 * @return {string} A string that indicates if the data type should be Boolean,
 * Integer, Float, String or something else.
 * @author Seth Hollingsead
 * @date 2020/10/16
 */
 ...
 * @param {stringt} inputData The string that should be checked if it is a floating point style value or not.
 * @param {string} inputMetaData Not used for this business rule.
...
/**
 * @function isString
 * @description Determines if the input string is a string or not, but process of elimination,
 ...
 * @param {string} inputMetaData Not used for this business rule.
 * @return {boolean} A Boolean value of true or false to indicate if the input string is a string and not a Boolean, Integer or Float;
 * or not (meaning it would be one of those 3 data types, discuised as a string).
 * @author Seth Hollingsead
 * @date 2020/10/16
 */
export const isString = function(inputData, inputMetaData) {
  ...
  (typeof inputData == 'string' || inputData instanceof String)) {
    returnData = true; // If it's not a Boolean, and not an Integer, and not a Float,
    // then it must be a string, especially given the type of the variable is a string!
  } else {
    returnData = false;
  }
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
...
export const singleQuoteSwapAfterEquals = function(inputData, inputMetaData) {
  ...
  if (inputData.includes(b.cSingleQuote) === true) {
    ...
    returnData = replaceCharacterWithCharacter(inputData, [/'/g, b.cDoubleQuote]);
    // Next replace the first and las double quote with single quote.
    if (returnData.indexOf(b.cDoubleQuote) === 0) {
      // returnData = inputData.replace(b.cDoubleQuote, b.cSingleQuote);
      returnData = replaceCharacterWithCharacter(inputData, [b.cDoubleQuote, b.cSingleQuote]);
    }
 ...
 * @param {string} inputMetaData Not used for this business rule.
 * @return {string} The same as the input string, just all forward slash characters swapped for back slash characters.
 * @author Seth Hollingsead
 * @date 2020/10/16
 */
 ...
 * @description Swaps all the back slash characters in a string for forward slash characters.
 * @param {string} inputData String that might contain some back slashes.
 * @param {string} inputMetaData Not used for this business rule.
 * @return {string} The same as the input string, just all back slash characters swapped for forward slash characters.
 * @author Seth Hollingsead
 * @date 2020/10/16
 */
 ...
 * @param {string} inputMetaData Not used for this business rule.
 * @return {string} The same as the input string, just all double forward slash characters swapped for single forward slash characters.
 * @author Seth Hollingsead
 * @date 2020/10/16
 */
 ...
 * @param {string} inputData String that might contain some double back slahses.
 * @param {string} inputMetaData Not used for this business rule.
 * @return {string} The same as the input string, just all double back slash characters swaqpped for single back slash characters.
 * @author Seth Hollingsead
 * @date 2020/10/16
 */
 ...
 * @param {string} inputData A string that may or may not contain the specified characters
 * that should be converted to another specified character.
 * @param {array<string,string>} inputMetaData An array of data that contains 2 additionl string parameters.
 * inputMetaData[0] === character2Find - The character to be searched and replaced from the input string.
 * inputMetaData[1] === character2Replace - The character that should be used to replace the character
 * specified for replacement from the input data.
...
export const cleanCarriageReturnFromString = function(inputData, inputMetaData) {
  ...
  let returnData = replaceCharacterWithCharacter(inputData, [/\s+/g, b.cSpace]).trim();
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cEND_Function);
  return returnData;
};
...
export const removeFileExtensionFromFileName = function(inputData, inputMetaData) {
  ...
  let returnData = replaceCharacterWithCharacter(inputData, [/\.[^/.]+$/], '');
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cEND_Function);
  return returnData;
};
...
export const getValueFromAssignmentOperationString = function(inputData, inputMetaData) {
  ...
  let returnData = replaceCharacterWithCharacter(parsedString[1], [/['"]+/g, '']);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cEND_Function);
  return returnData;
};
...
export const aggregateNumericalDifferenceBetweenTwoStrings = function(inputData, inputMetaData) {
  ...
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cinputMetaDataIs + inputMetaData);
  let returnData;
  // Convert the input string to lower case and clean them up for parsing.
  // let string1 = inputData.toLowerCase().replace(/\W/g, '');
  let string1 = convertStringToLowerCase(replaceCharacterWithCharacter(inputData, [/\W/g, '']));
  // let string2 = inputMetaData.toLowerCase().replace(/\W/g, '');
  let string2 = convertStringToLowerCase(replaceCharacterWithCharacter(inputMetaData, [/\W/g, '']));
  ...
  loggers.consoleLog(baseFileName + b.cDot + functionName, 'variation0 is: ' + variation0);
  loggers.consoleLog(baseFileName + b.cDot + functionName, 'variation1 is: ' + variation1);
  ...
  for (let i = 0; i < string1.length; i++) {
    ...
    for (let j = 0; j < string2.length; j++) {
      ...
      let insertionCost = variation[j] + 1;
      ...
      loggers.consoleLog(baseFileName + b.cDot + functionName, 'variational value is: ' + variation1);
    } // End j-loop
    let temp = variation1;
...
export const convertCamelCaseStringToArray = function(inputData, inputMetaData) {
  ...
  for (let i = 1; i < inputData.length; i++) {
    if (g.cUpperCaseEnglishAlphabet.includes(inputData.charAt(i))) { capitalLetters.push(i); }
  }
  if (capitalLetters.length > 0) {
    let last = 0;
    let decomposedString = [];
    for (let j = 0; j < capitalLetters.length; j++) {
      decomposedString.push(inputData.slice(last, capitalLetters[j]).toLowerCase());
      last = capitalLetters[j];
    }
...
export const convertArrayToCamelCaseString = function(inputData, inputMetaData) {
  ...
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cinputDataIs + inputData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cinputMetaDataIs + inputMetaData);
  let returnData = inputData.map((key, index) => mapWordToCamelCaseWord(key, index));
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cEND_Function);
  return returnData;
};
...
export const mapWordToCamelCaseWord = function(inputData, inputMetaData) {
  ...
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cinputDataIs + inputData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cinputMetaDataIs + inputMetaData);
  // let returnData = inputData.replace(/^./, character => character.toUpperCase());
  let returnData = replaceCharacterWithCharacter(inputData, [/^./, character => character.toUpperCase()]);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cEND_Function);
  return returnData;
};
 ...
 * @description Takes a string, and returns a version of it converted to lower case, with all digits and symbols and whitespace removed.
 * @param {string} inputData The string that should be simplified and consolidated.
 * @param {string} inputMetaData Not used for this business rule.
 * @return {string} A string that has been simplified and consolidated by converted to lower case, removing all digits, symbols and white space.
 * @author Seth Hollingsead
 * @date 2020/10/21
 * @NOTE I think this function is not completely working as expected, probably something to do with the regular expression.
...
export const simplifyAndConsolidateString = function(inputData, inputMetaData) {
  ...
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cinputDataIs + inputData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cinputMetaDataIs + inputMetaData);
  let returnData = _.replace(inputData.toLowerCase(), /[\W]/g, '');
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cEND_Function);
  return returnData;
};
 ...
 * @description Compares two strings by their simplified versions (see simplifyAndColidateString()).
...
export const compareSimplifiedAndConsolidatedStrings = function(inputData, inputMetaData) {
  ...
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cinputDataIs + inputData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cinputMetaDataIs + inputMetaData);
  let returnData = simplifyAndConsolidateString(inputData) === simplifyAndConsolidateString(inputMetaData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cEND_Function);
  return returnData;
};
 ...
 * @param {string|boolean|integer|object} inputData The character/value that should be searched for in the array of elements.
 ...
 * @param {array<string|boolean|integer|float|object>} inputMetaData The array from which all instances of the input character, integer, etc. should be removed.
 * @return {array<string|boolean|integer|float|object>} The array after having the specified character removed from all elements of the input array.
 * @author Seth Hollingsead
 * @date 2020/10/21
 */
 ...
 * @return {boolean} A boolean value to indiate if the file names are equavalent.
 * @author Seth Hollingsead
 * @date 2020/10/21
 */
 ...
 * @description Validates that validation data to ensure that all the contents of the constants validation data matches with the actual constants definitions.
 ...
 * @return {boolean} True or False to indiate if all of the contents of the constants are fully validated or not.
 * @author Seth Hollingsead
 * @date 2020/10/21
 */
    ...
    if (lineInCode.includes(s.cexportconst) === true) {
      ...
      if (foundConstant === true) {
        ...
        if (configurator.getConfigurationSetting(s.cDisplayIndividualConstantsValidationFailMessages) === true) {
          ...
          failMessage = chalk.brRgb(255,0,0)(failMessage);
 ...
 * specified by the input parameter and validates the context.
 * @param {string} inputData The name of the data-hive that should contain all of the
 * validation data that should be used to execute the validation procedures.
 * @param {string} inputMetaData Not used for this business rule.
...
export const validateConstantsDataValues = function(inputData, inputMetaData) {
  ...
  for (let i = 0; i < D[s.cConstantsValidationData][inputData].length; i++) {
    ...
    if (validationLineItem.Actual === validationLineItem.Expected) {
      ...
      returnData = false;
      if (configurator.getConfigurationSetting(s.cDisplayIndividualConstantsValidationFailMessages) === true) {
        let failMessage = `FAIL -- ${inputData} Actual: ${validationLineItem.Actual}, Expected: ${validationLineItem.Expected} -- FAIL`;
        failMessage = chalk.rgb(0,0,0)(failMessage);
...
// ********************************************************************************
// The following functions/business rules are more domain specific
// ********************************************************************************
 ...
 * @param {string} inputData The data context name, which should also contain the data catagory and cata catagory detail name seperated by an underscore.
 * @param {string} inputMetaData Not used for this business rule.
 ...
 * @description Gets the keyword name from the context name, E.g. Input: Keywords_ProjectDetails_DeleteEntireProject,
 * keyword is: 'DeleteEntireProject'.
 * @param {string} inputData The data context name, which should also contain the data catagory and data catagory detail name
 * and keyword name seperated by an underscore.
 * @param {string} inputMetaData Not used for this business rule.
...
export const getKeywordNameFromDataContextName = function(inputData, inputMetaData) {
  ...
  loggers.consoleLog(baseFileName + b.cDot + functionName, 'Data Catagory Detail Name should be: ' + dataCatagoryKeywordName[2]);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cEND_Function);
  return returnData;
};
 ...
 * This business rule looks for the "AppName" pars of the path
...
export const parseSystemRootPath = function(inputData, inputMetaData) {
  ...
  let returnData = '';
  let applicationName = configurator.getConfigurationSetting(s.cApoplicationName);
 ...
 * @description Parses the input string and replaces any instance of a double percentage sign  with the input Meta Data string.
...
export const replaceDoublePercentWithMessage = function(inputData, inputMetaData) {
  ...
  let returnData = '';
  returnData = replaceCharacterWithCharacter(inputData, [b.cPercent + b.cPercent, inputMetaData]);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.creturnDataIs + returnData);
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cEND_Function);
  return returnData;
};
 ...
 * @description Removes X number of folders from the end of the a path and returns the newly modified path.
 ...
 * but I provided it here anyways for completeness of code.
 */
 ...
 * @param {array<string|object|map} array The input array that should be searched for the given input value.
 * @param {string|integer|object} value The value that should be searched for in the input array.
...
function doesArrayContainValue(array, value, myFunction) {
  ...
  loggers.consoleLog(baseFileName + b.cDot + functionName, s.cBEGIN_Function);
  loggers.consoleLog(baseFileName + b.cDot + functionName, 'array value is: ' + JSON.stringify(array));
